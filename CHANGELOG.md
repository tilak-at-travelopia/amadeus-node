...
Add support for saving API requests and responses to files for debugging and auditing purposes.

- New `saveToFile` option to enable saving requests/responses to JSON files
- New `logDirectory` option to specify the directory for saving log files
